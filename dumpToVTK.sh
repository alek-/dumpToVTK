...
awk '{print $4, $5, $6}' $tmpfile >> $datafile

#echo "Vertices"
let atoms2=$atoms*2
printf "VERTICES $atoms $atoms2\n" >> $datafile
awk -v var="$atoms" '{print $2, NR-1}' $tmpfile >> $datafile

#echo "Point data"
printf "POINT_DATA $atoms\n" >> $datafile
printf "VECTORS i float\n" >> $datafile
awk '{print $7, $8, $9}' $tmpfile >> $datafile

#echo "Forces"
printf "VECTORS f float\n" >> $datafile
awk '{print $13, $14, $15}' $tmpfile >> $datafile

#echo "Omega"
printf "VECTORS omega float\n" >> $datafile
awk '{print $16, $17, $18}' $tmpfile >> $datafile

#echo "Velocities"
printf "VECTORS v float\n" >> $datafile
awk '{print $10, $11, $12}' $tmpfile >> $datafile

#echo "Radius"
printf "SCALARS radius float 1\n" >> $datafile
printf "LOOKUP_TABLE default\n" >> $datafile
awk '{print $19}' $tmpfile >> $datafile
